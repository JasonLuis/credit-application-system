...
class CustomerResourceTest {
    ...
    fun `should find customer by id and return 200 status`() {
        ...
        mockMvc.perform(
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Jason"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Santos"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("94181492060"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("jason@email.com"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("3000.0"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua da SP, 444"))
                //.andExpect(MockMvcResultMatchers.jsonPath("$.id").value(1))
                .andDo(MockMvcResultHandlers.print())
    }
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Jason"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Luis"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("94181492060"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("jason@email.com"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("4000.0"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua da SP, 445"))
                //.andExpect(MockMvcResultMatchers.jsonPath("$.id").value(1))
                .andDo(MockMvcResultHandlers.print())
    }
    ...
    private fun builderCustomerDto(
            ...
            cpf: String = "94181492060",
            email: String = "jason@email.com",
            income: BigDecimal = BigDecimal.valueOf(1000.0),
            password: String = "2345",
            zipCode: String = "000000",
            street: String = "Rua da SP, 234",
    ) = CustomerDto(
            firstName = firstName,
            lastName = lastName,
            cpf = cpf,
    ...
    private fun builderCustomerUpdateDto(
            firstName: String = "Jason",
            lastName: String = "Luis",
            income: BigDecimal = BigDecimal.valueOf(6000.0),
            zipCode: String = "45556",
            street: String = "Rua VGP SP"
